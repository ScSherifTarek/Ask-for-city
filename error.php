...
<div class="content">
	...
	<p>We know it’s scary, but "<?= (isset($_GET['city']))?$_GET['city'] : 'the page' ?>" you’re trying to reach can’t be found. Perhaps it was just a bad <span>link</span> dream? We will send you back to try to reach another city</p>
</div>
